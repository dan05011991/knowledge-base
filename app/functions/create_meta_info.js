...
function create_meta_info (meta_title, meta_description, meta_group, meta_sort) {

  var yamlDocument = {};
  var meta_info_is_present = meta_title || meta_description || meta_group || meta_sort;
  ...
  if (meta_info_is_present) {
    ...
    if (meta_group)       { yamlDocument.Group = meta_group;                    }
